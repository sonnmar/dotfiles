...
--  You can configure plugins using the `config` key or after the setup call
...
require('lazy').setup({
  ...
  -- Set bufferline to show open buffers
  {
  ...
  -- Load automatically your own plugins, configuration, etc from `lua/custom/plugins/*.lua`
